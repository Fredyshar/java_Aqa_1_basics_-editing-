...
//покупка в пределах лимита
    @Test
    public void showHowMuchToSpendIfThePurchaseIsLessThanTheLimit_API() {
    ...
    //покупка больше лимита
    @Test
    public void showHowMuchToSpendIfThePurchaseIsOverThanTheLimit_API() {
    ...
    //покупка равна лимиту
    @Test
    public void showHowMuchToSpendIfThePurchaseIsEqualToTheLimit_API() {
    ...
    //верхнее граничные значения - меньше
    @Test
    public void upperLimitValueLessThanLimit_API() {
    ...
    //верхнее граничные значения - больше
    @Test
    public void upperLimitValueGreaterThanLimit_API() {
    ...
    //покупка ноль
    @Test
    public void ifPurchaseEqualNull_API() {
    ...
    //покупка отрицательная
    @Test
    public void ifPurchaseNegative_API() {
    ...
    //нижнее граничное значение
    @Test
    public void bottonLimitValueGreaterThanLimit_API() {
